...
const jobs = ["Truck Driver", "Bus Driver", "Factory Worker", "Construction Worker", "Welder", "Plumer"];
...
function FourthPart() {
  ...
  return (
    <div className="mx-auto grid max-w-[1000px] items-center gap-[34px] grid-cols-[0.9fr_1fr]">
      <div className="order-2 flex justify-center order-1 justify-start pl-[10px]">
        <img
      ...
      <div className="order-1 mx-auto w-full max-w-[640px] lg:order-2">
        ...
        <h2 className="mt-[8px] max-w-[420px] text-[38px] font-bold leading-[1.06] text-[color:var(--avac-gold)]">
          Let Your Wanderlust
        ...
        <form className="mt-[20px] rounded-[18px] bg-white px-[18px] pb-[24px] pt-[20px] shadow-[0_18px_60px_rgba(51,45,18,0.08)] sm:px-[24px] sm:pb-[30px] sm:pt-[24px] lg:mt-[18px] lg:rounded-[20px] lg:px-[20px] lg:pb-[24px] lg:pt-[22px]">
            ...
            <label className="block">
              ...
              <div ref={jobDropdownRef} className="relative">
                <button
                  ...
                  className="flex h-[48px] w-full items-center justify-between rounded-full border border-[#E3DBD8] bg-white px-[16px] text-left text-[12px] outline-none cursor-pointer"
                >
                  <span
                    className={
                      isJobOpen
                ...
                {isJobOpen ? (
                  ...
                  {jobs.map((job) => (
                    <button
                      ...
                      className="block w-full px-[22px] py-[8px] text-left text-[11px] leading-[1.6] transition hover:bg-[#f6f6f6] cursor-pointer"
                    >
                      {job}
                    </button>
                  ))}
          ...
          <button
            type="submit"
            className="mx-auto mt-[20px] flex h-[52px] w-full max-w-[170px] items-center justify-center rounded-full bg-[color:var(--avac-gold)] px-[24px] text-[11px] font-semibold text-white transition hover:brightness-105 cursor-pointer"
          >
            Send Message
          </button>
        </form>
