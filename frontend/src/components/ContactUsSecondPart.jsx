...
function ContactUsSecondPart() {
  return (
    <section className="bg-white px-4 pb-[68px] pt-[0px] text-black sm:px-8 sm:pb-[92px]">
      <div className="mx-auto max-w-[1450px]">
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <h2 className="mt-[14px] text-[34px] font-bold leading-[1.06] text-[color:var(--avac-gold)]">
        ...
        <div className="mx-auto mt-[38px] max-w-[1170px] rounded-[24px] bg-white px-[20px] py-[20px] shadow-[0_24px_80px_rgba(174,150,111,0.16)] sm:mt-[52px] sm:px-[45px] sm:py-[45px]">
          <div className="grid gap-[26px] sm:grid-cols-[1.02fr_0.92fr_1.22fr] sm:items-center sm:gap-[34px]">
            <div className="space-y-[18px] sm:pl-[6px]">
            ...
            <div className="border-[#ece4d8] sm:border-l sm:pl-[42px]">
